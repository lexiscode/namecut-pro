                ...
                <div class="card card-statistics dating-contant h-100 mb-0">
                    ...
                    <div class="col-xxl-4 m-b-30">
                        <div class="card card-statistics h-100 m-b-0">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.publish-receipt.store') }}" enctype="multipart/form-data" class="needs-validation" novalidate="">
                                    @csrf

                                    <div class="form-group">
                                        <input type="number" class="form-control" name="user_id" placeholder='Enter the correct client #Id'>
                                    </div>
                                    <div class="form-group">
