            ...
            <div class="col-xxl-9 m-b-30">
                <div class="card card-statistics dating-contant h-100 mb-0">
                    <div class="card-header d-flex align-items-center justify-content-between"> <!---->
                        ...
                        <div class="dropdown">
                            <a class="btn btn-primary" href="{{ route('admin.admins.create') }}" aria-haspopup="true" aria-expanded="false">
                                Add New
                            </a>
                        </div>
                    </div>
                                ...
                                <tbody class="text-muted">
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.admins.edit', $admin->id) }}" class="mr-2">
                                                    <i class="fa fa-pencil" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"></i>
                                                </a>
                                                <a href="{{ route('admin.admins.destroy', $admin->id) }}" class="delete-item">
