        ...
        <div class="row">
            ...
            <div class="form_container">
                ...
                <form method="POST" action="{{ route('contact') }}">
                    @csrf
                    <div>
                        <input type="text" name="name" value="{{ $client_form->fullname }}" placeholder="Your Name" disabled />
                    </div>
                    <div>
                        <input type="text" name="phone_no" value="{{ $client_form->phone_no }}" placeholder="Phone Number" disabled />
                    </div>
                    <div>
